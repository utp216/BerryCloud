...
sudo apt-get update
sudo apt-get install -y software-properties-common ifupdown python-software-properties net-tools sudo nano git linux-firmware dnsutils language-pack-en-base expect aptitude dialog lvm2 ntp curl initscripts keyboard-configuration
